<div>
  <nav class="navbar navbar-expand-lg navbar-dark gradient-custom">
    <div class="container-fluid ms-3">
      <a><img src="../Assets/Images/logonav2.png" style="width: 200px; height: 50px;" alt="logo"></a>

      <!-- Collapsible wrapper -->
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <!-- Left links -->
        <ul class="navbar-nav ms-auto d-flex flex-row me-5 mt-2 mt-lg-0">
          <li class="nav-item text-center mx-2 mx-lg-1 d-flex align-items-center" style="height: 100%;">
          ...
          <li class="nav-item text-center mx-2 mx-lg-1 d-flex align-items-center" style="height: 100%; padding-top: 25px;">
        ...
        <!-- Right links -->
        <ul class="navbar-nav ms-auto d-flex flex-row mt-2 mt-lg-0 me-3">
          <li class="nav-item dropdown mx-2 mx-lg-1 d-flex align-items-center" style="height: 100%;">
            ...
            <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown" style="margin-top: 8px; border-radius: 10px;">
              <li><a class="dropdown-item text-white" href="#">Settings</a></li>
              <li><a class="dropdown-item text-white" href="#">Analytics</a></li>
