...
<style>
  ...
  .nav-item.dropdown:hover .dropdown-menu {
    display: block;
    margin-top: 8px;
    /* Adjust the space between the dropdown and the navbar */
  }
  ...
  .navbar-nav .nav-item .dropdown-menu {
    background-color: #0C134F !important;
    /* Matches navbar background color */
  }
  ...
  .dropdown-menu a:hover {
    ...
    /* Slight hover effect on menu items */
  }
  ...
  .nav-item.dropdown .dropdown-menu {
    position: absolute;
    top: 100%;
    /* Positions it directly below the icon */
    left: -100px;
    right: 0;
    border-radius: 10px;
  }
